      ...
      <AboutMeContentContainer ref={cardRef}>
        <AboutMeTextWrapper>
          ...
          <MyText size={"1rem"} weight={"400"} opacity={0.9}>
            ...
            myself really enjoy coding and building program work exactly as
            designed.
          </MyText>
          <Spacer position={"top"} size={"1rem"} />
          <MyText size={"1rem"} weight={"400"} opacity={0.9}>
            Afterward I started to learn web development while building a web
            scraper, and it opens up a whole new world for me. I dive into web
            development from front-end to back-end, building fully functional
            application, and keep improving my skills.
          </MyText>
          {/*<Spacer position={"top"} size={"1rem"} />
                    <MyText size={"1rem"} weight={"400"} opacity={0.9}>
